...
#'
#' @examples
getMoonplot.MCA = function(result, rextra = .1, textmax = .2, flip = F, row_col = NULL, col_col = NULL){
  getMoonplot_general(result$ind$coord, result$var$coord, rextra = rextra, textmax = textmax, flip = flip, row_col = row_col, col_col = col_col)
}

#' @rdname getMoonplot
#' @export
getMoonplot.CA = function(result, rextra = .1, textmax = .2, flip = F, label_rows = F, row_col = NULL, col_col = NULL){
...
getMoonplot_general = function(row_coords, col_coords, rextra = .1, textmax = .2, flip = F, label_rows = F, row_col = NULL, col_col = NULL){
